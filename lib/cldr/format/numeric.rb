  ...
  module Format
    class Numeric < Base
      ...
      def apply(number, options = {})
        ...
        result =  formats[:int].apply(int, options)
      ...
      protected
        ...
        def parse_format(format, symbols = {})
          ...
          formats = { :prefix => $1.to_s, :suffix => $3.to_s, :int => Integer.new(int, symbols) }
          formats[:fraction] = Fraction.new(fraction, symbols) if fraction
          formats
        end
