...
class TestFile < Test::Unit::TestCase
  ...
  def test_removes_draft_pairs_and_empty_ancestors
        ...
        <fields>
          <field type="quarter-narrow">
            ...
            <relativeTime type="future">
              <relativeTimePattern draft="unconfirmed" count="one">in {0} Q</relativeTimePattern>
              <relativeTimePattern draft="unconfirmed" count="other">in {0} Q</relativeTimePattern>
            </relativeTime>
          </field>
        </fields>
      </ldml>
    ...
    parsed = Cldr::Export::DataFile.parse(xml_contents, minimum_draft_status: Cldr::DraftStatus::PROVISIONAL)
